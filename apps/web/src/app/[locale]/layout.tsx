...
export default async function LocaleLayout({
  ...
  // ar est RTL et n'est pas encore routable (§07 du cahier des charges) —
  // cette bascule reste correcte le jour où sa traduction est prête.
    ...
    <html lang={locale} dir={dir}>
      <body className="min-h-screen bg-white text-ink antialiased">
        <NextIntlClientProvider locale={locale} messages={messages}>
          ...
          <main className="mx-auto max-w-md px-4 py-8 sm:max-w-2xl">{children}</main>
