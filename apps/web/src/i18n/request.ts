...
import ar from "@sbr/locales/ar.json";
...
// est trivial à étendre le jour où bas rejoint `locales`.
const messagesByLocale: Record<AppLocale, typeof fr> = { fr, en, es, de, ar };
